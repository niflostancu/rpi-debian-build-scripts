# Utility functions library usable by both host & rootfs scripts
# Will be copied to /usr/local/lib/rpi-debian-scripts.sh
...
# Interpolates multiple '{VARIABLES}' within a given TEMPLATE.
